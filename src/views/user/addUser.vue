  ...
  <div>
    <el-form ref="form" :rules="rules" :model="userData" label-width="80px" style="margin:20px">
      ...
      <el-form-item label="身份" prop="dentity">
        <el-radio v-if="userInfo.dentity == '老师' " v-model="userData.dentity" label="学生">学生</el-radio>
        <el-radio v-if="userInfo.dentity == '项目管理员' " v-model="userData.dentity" label="老师">老师</el-radio>
        <el-radio v-if="userInfo.dentity == '超级管理员' " v-model="userData.dentity" label="项目管理员">项目管理员</el-radio>
      </el-form-item>
      ...
      <el-form-item label="班级" v-if="userInfo.dentity == '老师'" prop="clazz">
      ...
      <el-form-item label="班级" v-if="userInfo.dentity == '项目管理员'" prop="clazz">
      ...
      this.$refs[from].validate(valid => {
        if (valid) {
          ...
          if (this.classList.length > 0) {
            ...
            console.log(className.substring(0, className.length - 1));
